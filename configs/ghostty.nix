  ...
  hjem.users.${username} = {
    ...
    files = {
      ...
      ".config/ghostty/config".text = ''
        ...
        cursor-color = ${c.primary.dark.color}
        cursor-text = ${c.on_primary.dark.color}
        selection-background = ${c.secondary_container.dark.color}
        selection-foreground = ${c.on_secondary_container.dark.color}
        palette = 0=${c.surface_container_high.dark.color}
        palette = 1=${c.error.dark.color}
        palette = 2=${c.primary.dark.color}
        palette = 3=${c.tertiary.dark.color}
        palette = 4=${c.secondary.dark.color}
        palette = 5=${c.primary_fixed.dark.color}
        palette = 6=${c.secondary_fixed.dark.color}
        palette = 7=${c.on_surface_variant.dark.color}
        palette = 8=${c.outline.dark.color}
        palette = 9=${c.error_container.dark.color}
        palette = 10=${c.primary_container.dark.color}
        palette = 11=${c.tertiary_container.dark.color}
        palette = 12=${c.secondary_container.dark.color}
        palette = 13=${c.inverse_primary.dark.color}
        palette = 14=${c.outline_variant.dark.color}
        palette = 15=${c.on_surface.dark.color}
      '';

      # Stripped-down. see https://raw.githubusercontent.com/sahaj-b/ghostty-cursor-shaders/refs/heads/main/cursor_warp.glsl for original.
      ".config/ghostty/shaders/cursor_warp.glsl".text = ''
