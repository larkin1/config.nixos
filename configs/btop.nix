...
let
  ...
  output = ".config/${name}/themes/matugen.theme";
in {
  config = {
    ...
    hjem.users.${username} = {
      ...
      files = {
        # Stripped-down. see https://raw.githubusercontent.com/InioX/matugen-themes/refs/heads/main/templates/btop.theme for original.
        "${input}".text = ''
          theme[main_bg]=""
